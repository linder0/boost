...
export default async function DiscoverRestaurantsPage({
  params,
}: {
  ...
  // Get emails of existing restaurants to mark as already added
  ...
  return (
    <div className={PAGE_CONTAINER_CLASS}>
      <VenueDiscovery
        ...
        initialNeighborhoods={event.constraints?.neighborhoods}
        initialCuisines={event.constraints?.cuisines}
      />
    </div>
  )
}
